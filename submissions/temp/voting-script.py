...
# glob_files = ["./voted-submission-24.csv", "./submission-26.csv", "./submission-23.csv", "./submission-21.csv", "./submission-18.csv", "./submission-16.csv", "./submission-22.csv", "./submission-25.csv"]
